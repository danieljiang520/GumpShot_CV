...
int main(void)
{
  ...
  // gameConfig contains the followings: mode, speed, direction, launcher_timer, launcher_period, and error
//  gameConfig.mode = 0;
//  gameConfig.speed = 25;
//  gameConfig.direction = 90;
//  gameConfig.launcher_timer = 0;
//  gameConfig.launcher_period = 10;
//  gameConfig.error = 0;
